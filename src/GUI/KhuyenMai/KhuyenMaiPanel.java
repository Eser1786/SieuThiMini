...
public class KhuyenMaiPanel extends JPanel {
    ...
    private static final Color RIGHT_BG  = new Color(0x1565C0);
    private static final Color CARD_DARK = new Color(0x1A5276);
    private static final Color TBL_HDR   = new Color(0x0D47A1);
    ...
    private JPanel buildPageHeader() {
        ...
        JLabel lbl = new JLabel("QUảN LÝ KHUYỬN MÃI");
    ...
    private JPanel buildDetailCard(String idLabel, String nameLabel,
        ...
        hdr.setBackground(new Color(0xF0F4F8));
        hdr.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(0xCCCCCC)));
        JLabel lbHdr = new JLabel("\u24d8 Th\u00f4ng tin chi ti\u1ebft");
        lbHdr.setFont(new Font("Arial", Font.PLAIN, 13));
        lbHdr.setForeground(new Color(0x555555));
        hdr.add(lbHdr);
        ...
        lbId.setForeground(new Color(0x90CAF9));
        ...
        sep.setForeground(new Color(0x4488BB));
        ...
        if (descLabel != null) {
            ...
            lbDL.setForeground(new Color(0x90CAF9));
            ...
            ta.setBackground(new Color(0x154360));
            ta.setForeground(Color.WHITE);
            JScrollPane tas = new JScrollPane(ta);
            tas.setBorder(BorderFactory.createLineBorder(new Color(0x4488BB)));
            ...
            imgBox.setBackground(new Color(0x154360));
            imgBox.setBorder(BorderFactory.createLineBorder(new Color(0x4488BB)));
    ...
    private JPanel buildRightColumn() {
        ...
        col.add(buildListSection("Danh s\u00e1ch voucher", "+TH\u00caM VOUCHER", voucherModel));
        ...
        col.add(buildListSection("Danh s\u00e1ch gi\u1ea3m gi\u00e1 s\u1ea3n ph\u1ea9m",
                "+TH\u00caM KHUY\u1EECN M\u00C3I", discountModel));
        return col;
    }

    private JPanel buildListSection(String title, String addLabel, DefaultTableModel model) {
        ...
        btnRow.add(listBtn(addLabel,   new Color(0x0D47A1)));
        top.add(btnRow);
        ...
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                comp.setBackground(sel ? new Color(0xFFCC80)
                        : (r % 2 == 0 ? Color.WHITE : new Color(0xBBDEFB)));
                return comp;
            }
        });
