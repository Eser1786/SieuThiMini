...
public class SanPhamPanel extends JPanel {
    ...
    public SanPhamPanel() {
        ...
        model.addRow(
                new Object[] { "MD01", "", "Nước F trái K", "25.000đ", 7, "Còn hàng", "26/10/2026", "-2.000đ", "" });
        model.addRow(
                new Object[] { "MD02", "", "Thịt mèo cháy", "17.000đ", 7, "Còn hàng", "10/11/2026", "-7.000đ", "" });
        ...
        formBody.add(new JLabel("Mã SP"));
        formBody.add(tfMa);
        formBody.add(new JLabel("Tên"));
        formBody.add(tfTen);
        formBody.add(new JLabel("Giá"));
        formBody.add(tfGia);
        formBody.add(new JLabel("Số lượng"));
        formBody.add(tfSL);
        formBody.add(new JLabel("Ngày"));
        formBody.add(tfDate);
        formBody.add(new JLabel("Khuyến mãi"));
        formBody.add(tfKM);
