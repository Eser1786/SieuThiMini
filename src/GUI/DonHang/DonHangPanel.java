...
public class DonHangPanel extends JPanel {
    ...
    private JPanel buildDetailCard() {
        JPanel card = new JPanel(new BorderLayout());
        card.setBackground(new Color(0xF4F4F4)); // Nền xám nhạt
        ...
        Font lbFont = new Font("Arial", Font.BOLD, 14);
        ...
        JLabel lbNhanVien = makeVal(valFont); // User mới yêu cầu thêm Nhân viên
        ...
        addRow2(body, g, 4, "Trạng thái hiện tại:", lbTrangThai, valFont);
        ...
        addRow2(body, g, 7, "Tên người đặt:", lbTenND, valFont);
        addRow2(body, g, 8, "ID tài khoản:", lbIdTK, valFont);
        addRow2(body, g, 9, "Số điện thoại:", lbSdt, valFont);
        addRow2(body, g, 10, "Địa chỉ:", lbDiaChi, valFont);
        ...
        tblSP.setGridColor(Color.WHITE); // Giấu line ngang ở giữa để tự vẽ hoặc dể trắng
        ...
        addRow2(body, g, 16, "Tổng số tiền cần thanh toán:", lbTongTT, valFont);
        ...
        wgc.weightx = 1.0;
        wgc.weighty = 1.0;
        wgc.insets = new Insets(30, 0, 40, 0); // Lề trên/mép
        ...
        btnXacNhan = makeFootBtn("Xác nhận đơn", new Color(0x4CAF50));
        btnInHoaDon = makeFootBtn("In hoá đơn", new Color(0x8C9EFF));
        btnHuy = makeFootBtn("Huỷ đơn hàng", new Color(0xE53935));
    ...
    private JPanel buildInvoiceCard() {
        JPanel card = new JPanel(new BorderLayout());
        card.setBackground(new Color(0xF4F4F4));
        ...
        JButton btnPrint = makeFootBtn("In", new Color(0x8C9EFF));
